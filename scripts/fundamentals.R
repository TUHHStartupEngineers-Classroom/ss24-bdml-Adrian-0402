...
stores_tbl      <- read_excel(path  = "source_data/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Store Lookup",
                              skip  = 1)
products_tbl    <- read_excel(path  = "source_data/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Products Lookup",
                              skip  = 1)
transaction_tbl <- read_excel(path  = "source_data/breakfast_at_the_frat.xlsx",
...
get_cluster_trends(cluster = 1) %>% view()
