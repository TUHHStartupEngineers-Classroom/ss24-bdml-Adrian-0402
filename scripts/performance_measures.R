...
plot_h2o_leaderboard(automl_models_h2o@leaderboard,"logloss",10,3,T)
...
glm_h2o <- automl_models_h2o@leaderboard %>% 
  extract_h2o_model_name_by_position(12) %>% 
  h2o.getModel()

# Save the models
deeplearning_h2o %>% h2o.saveModel(path = "source_data/automated/models")
stacked_ensemble_h2o %>% h2o.saveModel(path = "source_data/automated/models")
glm_h2o %>% h2o.saveModel(path = "source_data/automated/models")
...
path <- "source_data/automated/models/DeepLearning_grid_2_AutoML_1_20240616_131553_model_4"
...
model_metrics_tbl <- fs::dir_info(path = "source_data/automated/models/") %>%
  select(path) %>%
