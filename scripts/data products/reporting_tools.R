...
fs::file_create("scripts/data products/plot_sales.R")

# 3.2 Save funtions to the file
dump(list = c("plot_total_sales", "plot_categories", "format_to_euro", "euro_format"), file = "scripts/data products/plot_sales.R")
